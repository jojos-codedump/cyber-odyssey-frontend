...
//
// FIX: auth.authStateReady() waits for Firebase to rehydrate its persisted
// session before we check currentUser. Without this, currentUser is null on
// every page load, causing "No authenticated session" even when logged in.
// ─────────────────────────────────────────────────────────────────────────────
